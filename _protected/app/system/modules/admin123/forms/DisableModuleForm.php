    ...
    public static function display()
    {
        ...
        foreach ($oModuleData as $oData) {
            ...
            if (in_array($oData->folderName, self::DEV_STAGE_MODS, true)) {
                $sAdditionalText .= '<span class="small red"> • ' . t('Only for development purpose to test it before <a href="%0%">opening a PR</a>. <a href="%1%">Social APIs</a> have to be updated.', 'https://github.com/pH7Software/pH7Builder/pulls', 'https://github.com/pH7Software/pH7Builder/blob/master/_protected/app/system/modules/connect/inc/class/') . '</span>';
            }
